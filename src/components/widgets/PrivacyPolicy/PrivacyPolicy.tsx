    ...
    <ContentContainer>
      <Substrate className={styles.substrate}>
        ...
        <div className={styles.content}>
          <div className={styles.title}>1. Общие положения</div>
          <Text className={styles.text}>
            Настоящая Политика конфиденциальности (далее — Политика) составлена в
            ...
            персональных данных, предпринимаемые ИП Аршба Илоной Станиславовной (далее —
            Оператор). <br />
            ...
            веб-сайта https://garant-abh.com.
          </Text>

          <div className={styles.title}>2. Основные понятия, используемые в Политике</div>
          ...
          <Text className={styles.text}>
            ...
            по сетевому адресу https://garant-abh.com. <br />
            ...
            определенному или определяемому Пользователю веб-сайта https://garant-abh.com.{" "}
            <br />
            ...
            2.10. Пользователь — любой посетитель веб-сайта https://garant-abh.com. <br />
          ...
          <div className={styles.title}>3. Основные права и обязанности Оператора</div>
          ...
          <Text className={styles.text}>
            ...
            субъектов персональных данных и их законных представителей в соответствии с
            ...
            случаях, предусмотренных Законом о персональных данных; <br />— исполнять иные
          ...
          <Text className={styles.text}>
            ...
            требования о прекращении обработки персональных данных; <br />
            ...
            при обработке его персональных данных; <br />
          ...
          <div className={styles.title}>5. Принципы обработки персональных данных</div>
          ...
          <div className={styles.title}>6. Цели обработки персональных данных</div>

          <div className={styles.text}>
            <DataTable />
          </div>

          <div className={styles.title}>7. Использование файлов Cookie</div>

          <Text className={styles.text}>
            7.1. Оператор использует файлы cookie и иные аналогичные технологии (в том
            числе пиксели и локальное хранилище браузера) для обеспечения корректной
            работы Веб-сайта, улучшения пользовательского опыта, аутентификации
            пользователя, предоставления пользователям Веб-сайта настроенное под них
            окружение при повторном посещении Веб-сайта. <br />
            7.2. Файлы cookie представляют собой фрагменты данных, которые сохраняются на
            устройстве пользователя при посещении Веб-сайта. С помощью cookie Оператор
            может получать следующую информацию: IP-адрес, данные о браузере пользователя,
            технические характеристики устройства, действия пользователя на сайте, дату и
            время посещения и другую техническую информацию. <br />
            7.3. Пользователь может в любой момент ограничить или полностью отключить
            использование файлов cookie с помощью настроек своего браузера. Однако это
            может повлиять на корректную работу отдельных функций Веб-сайта. <br />
            7.4. Информация собираемые посредством файлов cookie не позволяет однозначно
            идентифицировать пользователей Веб-сайта.
          </Text>

          <div className={styles.title}>8. Условия обработки персональных данных</div>
          ...
          <Text className={styles.text}>
            ...
            8.3. Обработка персональных данных необходима для осуществления правосудия,
            ...
            8.6. Осуществляется обработка персональных данных, доступ неограниченного
            круга лиц к которым предоставлен субъектом персональных данных либо по его
            просьбе (далее — общедоступные персональные данные). <br />
            8.7. Осуществляется обработка персональных данных, подлежащих опубликованию
            или обязательному раскрытию в соответствии с федеральным законом.
          </Text>

          <div className={styles.title}>
            9. Порядок сбора, хранения, передачи и других видов обработки персональных
            данных
          </div>
          ...
          <Text className={styles.text}>
            ...
            9.1. Оператор обеспечивает сохранность персональных данных и принимает все
            возможные меры, исключающие доступ к персональным данным неуполномоченных лиц.{" "}
            <br />
            9.2. Персональные данные Пользователя никогда, ни при каких условиях не будут
            ...
            9.3. В случае выявления неточностей в персональных данных, Пользователь может
            актуализировать их самостоятельно, путем направления Оператору уведомление на
            адрес электронной почты Оператора privacy@garant-abh.com с пометкой
            «Актуализация персональных данных». <br />
            9.4. Срок обработки персональных данных определяется достижением целей, для
            ...
            почты на электронный адрес Оператора privacy@garant-abh.com с пометкой «Отзыв
            согласия на обработку персональных данных». <br />
            9.5. Вся информация, которая собирается сторонними сервисами, в том числе
            ...
            9.6. Установленные субъектом персональных данных запреты на передачу (кроме
            ...
            9.8. Оператор осуществляет хранение персональных данных в форме, позволяющей
            определить субъекта персональных данных, не дольше, чем этого требуют цели
            обработки персональных данных, если срок хранения персональных данных не
            установлен федеральным законом, договором, стороной которого,
            выгодоприобретателем или поручителем по которому является субъект персональных
          ...
          <div className={styles.title}>
            10. Перечень действий, производимых Оператором с полученными персональными
            данными
          </div>
          ...
          <Text className={styles.text}>
            ...
            10.2. Оператор осуществляет автоматизированную обработку персональных данных с
          ...
          <Text className={styles.text}>
            Компания осуществляет трансграничную передачу ПДн на территории иностранных
            государств, в том числе на территорию Республики Абхазия.
          </Text>

          <div className={styles.title}>12. Конфиденциальность персональных данных</div>
          ...
          <div className={styles.title}>13. Заключительные положения</div>

          <Text className={styles.text}>
            13.1. Пользователь может получить любые разъяснения по интересующим вопросам,
            касающимся обработки его персональных данных, обратившись к Оператору с
            помощью электронной почты privacy@garant-abh.com. <br />
            ...
            новой версией. <br />
            13.3. Актуальная версия Политики в свободном доступе расположена в сети
            Интернет по адресу https://garant-abh.com/policy. <br />
          </Text>
        </div>
      </Substrate>
    </ContentContainer>
