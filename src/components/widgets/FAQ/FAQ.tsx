...
const FAQItems: IFAQItem[] = [
      ...
      <>
        <List
          items={[
            ...
            <Text>
              Заполните данные транспортного средства, собственника и выберите период
              страхования.
            </Text>,
  ...
  },
  {
    ...
    answer: (
      <>
        Полис ОСАГО оформляется на собственника автомобиля, а страхователем может быть
        любой человек, в том числе гражданин иностранного государства. Полис действует на{" "}
        <b>неограниченный круг водителей</b> — вписывать конкретных лиц не требуется.
      </>
    ),
  },
  {
      ...
      <>
        ...
        <List
          ...
          items={[
            ...
            <Text>
              Позвонить в страховую компанию по номеру +7 (940) 770-48-63 и сообщить о ДТП
            </Text>,
            <Text>
  ...
  },
  {
    ...
    answer: (
      <>
        ...
        исправленный полис. В сообщении укажите номер полиса и данные, которые нужно
        исправить.
      </>
    ),
  },
        ...
        <List
          ...
          items={[
            ...
            <Text>
              ...
              <b>«с правом выезда за рубеж»</b> (обычная доверенность в простой письменной
              форме не подойдет), либо договор аренды, образец которого можно скачать по{" "}
              <CustomLink
